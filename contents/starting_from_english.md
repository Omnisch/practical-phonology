...
- 英语作为国际语，其音系可以从三方面来批判。
    ...
    3. 音节结构。英语有很疯狂的辅音连缀（辅音连缀就是两个以上的辅音挤在一起），最为典型的是`strengths`，整个词只有一个单元音，前后却挂了 6 个辅音，可怕的是这样的词还不在少数。还是拿普通话举例，普通话的音节结构可以概括为`CVN<sup>T</sup>`，其中`C`是辅音，`V`是元音，`N`是末尾的鼻音，`<sup>T</sup>`是加在整个音节上的声调。没有一个字的读音打破这个结构，这就意味着普通话根本接触不到除了`-mp-`、`-nt-`、`-nk-`之外的辅音连缀，像`strengths`这样的词根本是在折磨舌头。
